...
const Calendar = ({
  ...
  return (
    <div className="md:col-span-2 bg-white rounded-lg shadow p-4 dark:bg-background dark:text-primary">
      <DayPicker
        mode="single"
        ...
        classNames={{
          ...
          nav_button: "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 text-primary dark:text-primary",
        ...
        modifiersClassNames={{
          outside: "opacity-50 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800",
